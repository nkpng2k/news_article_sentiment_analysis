...
if __name__ == '__main__':
    ...
    wsj_selenium = SeleniumUrls(filepath = filepath, csv_name = 'wsj_news_articles', site_name = 'wsj')
    ...
    guardian_selenium = SeleniumUrls(filepath = filepath, csv_name = 'guardian_news_articles', site_name = 'guardian')
    ...
    wash_post_selenium = SeleniumUrls(filepath = filepath, csv_name = 'wa_post_news_articles', site_name = 'wash_post')
    ...
    cnn_selenium = SeleniumUrls(filepath = filepath, csv_name = 'cnn_news_articles', site_name = 'cnn')
    ...
    fox_selenium = SeleniumUrls(filepath = filepath, csv_name = 'fox_news_articles', site_name = 'fox')
    ...
    nyt_selenium = SeleniumUrls(filepath = filepath, csv_name = 'nyt_news_articles', site_name = 'nyt')
